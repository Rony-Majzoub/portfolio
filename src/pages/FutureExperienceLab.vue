...
export default {
  ...
  data() {
    return {
      ...
      team: [
        ...
        {
          teamName: "Marcus Hägerstrand",
        },
        {
          teamName: "Nema Vinkeloe Uuskyla",
        },
      ],
  ...
  methods: {
    stylePageBefore() {
      document
        .querySelector("body")
        .setAttribute("style", "background-color:#212121");
      document
    ...
    stylePageMount() {
      ...
      for (var i = 0; i < eggplant.length; i++) {
        eggplant[i].setAttribute("style", "background-color: #333333");
      }
      document
