<template>
  <div
    class="cursor-pointer relative h-64 max-w-full rounded-lg overflow-hidden group transition-all ease-in-out duration-300 shadow-md hover:-translate-y-1 transform-gpu"
