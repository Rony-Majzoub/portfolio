<template>
  <figure
    class="max-w-screen-2xl relative lg:flex-row-reverse flex flex-col !bg-eggplant rounded-xl overflow-hidden lg:p-0 col-start-2 col-end-[-2] transition-all ease-in-out duration-300 lg:hover:-translate-y-1 lg:hover:shadow-2xl lg:hover:shadow-[#2b212c] animation-item transform-gpu">
    <!-- Image Container -->
    <router-link
      v-once
