<template>
  <figure
    class="max-w-screen-2xl relative lg:flex-row flex flex-col !bg-eggplant rounded-xl lg:p-0 col-start-2 col-end-[-2] lg:h-128 transition-all ease-in-out duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#2b212c] mb-40 animation-item">
    <!-- Image Container -->
    <router-link
