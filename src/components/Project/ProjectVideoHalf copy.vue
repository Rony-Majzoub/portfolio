      ...
      <div class="flex flex-1 justify-center items-center p-8">
        ...
        <div
          ...
          <!-- <video
            ...
            :poster="`https://res.cloudinary.com/rony-majzoub/video/upload/w_auto/${videoLink}.jpg`"
            :autoplay="autoplay"
            :controls="controls"
            :loop="loop"
            :muted="muted"
            ...
            height="216">
            <source
              :src="`https://res.cloudinary.com/rony-majzoub/video/upload/w_auto/${videoLink}.webm`"
              type="video/webm" />
            <source
              :src="`https://res.cloudinary.com/rony-majzoub/video/upload/w_auto/${videoLink}.mp4`"
              type="video/mp4" />
            <source
              :src="`https://res.cloudinary.com/rony-majzoub/video/upload/w_auto/${videoLink}.ogv`"
              type="video/ogg" />
          </video> -->
          <video
            ...
            :playsinline="loop" />
          <!-- <video
            :data-src="`https://res.cloudinary.com/rony-majzoub/video/upload/w_auto/${videoLink}`"
            :alt="`${altText}`"
