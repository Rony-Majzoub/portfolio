<template>
  <figure
    class="relative lg:flex-row flex flex-col bg-eggplant rounded-xl lg:p-0 col-span-full lg:min-h-128 lg:h-fit w-full max-w-6xl transition-all ease-in-out duration-300 hover:-translate-y-1 group transform-gpu">
    <figure
      class="lg:flex-row hover:flex flex-col bg-eggplant rounded-xl lg:p-0 col-span-full absolute w-full h-full left-0 top-0 z-[-10] blur-xl contrast-200 mix-blend-lighten opacity-0 group-hover:opacity-50 will-change-[opacity,_filter] transition-opacity ease-in-out duration-300 transform-gpu">
      <div
      ...
      <div
        class="hidden pt-6 p-8 text-left lg:mb-0 w-full space-y-4 lg:flex lg:flex-col lg:h-full max-w-prose"></div>
    </figure>
    <div
      class="overflow-hidden w-full lg:w-4/12 lg:rounded-none lg:rounded-l-xl rounded-t-xl lg:max-w-fit">
      <img
    ...
    <div
      ...
      <figcaption class="space-y-2 lg:space-y-4">
        <div
          class="text-pastel-pink font-normal text-xs lg:text-sm tracking-widest uppercase antialiased">
          About Me
        </div>
        <h1 class="text-unbleached-silk font-medium text-5xl antialiased">
          Rony Majzoub
        </h1>
      </figcaption>
      <blockquote>
        <p class="text-base lg:text-lg font-normal text-melon max-w-prose">
      ...
      <footer class="flex flex-col gap-4 pt-4 lg:pt-8">
        <h3
          class="text-unbleached-silk font-medium text-lg lg:text-xl tracking-wider uppercase antialiased">
          Interests
        </h3>
